...
# create inverse aggregated function in order to plug in quantities
agg_func_inv <- function(quantity){
quantity/(low_fit$coefficients[2]+ high_fit$coefficients[2]) - agg_func(0)
}
...
Consumer benefit defined above is equal to the sum of the consumer benefit of high income consumers and the consumer benefit of low income consumers.
